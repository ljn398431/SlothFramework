...
---@class Game.Actions.CarouselResetAction
...
function M:ctor(serverData)
    warn("CarouselResetAction:ctor", table.dump_r(serverData))
    self.owner = _APP.AI
end

function M:GetActionName()
    return "CarouselResetAction"
end

function M:OnEnter()
    warn("CarouselResetAction:OnEnter")
    M.super.OnEnter(self)
    self.serverData.callback()
end
...
function M:OnLeave(msg)
    ...
    warn("CarouselResetAction:OnLeave", msg)
end
