...
---@class Game.Actions.VoiceAction
...
function M:ctor(serverData)
    warn("VoiceAction:ctor", table.dump_r(serverData))
    self.owner = _APP.AI
    ChatTextAction.new({ duration = 100, content = serverData.text ,isSelf = true}, self)
