...
---@alias AnimatorControllerLoadCallback fun(controller: CS.UnityEngine.RuntimeAnimatorController):void
---@alias AnimationClipLoadCallback fun(clip: CS.UnityEngine.AnimationClip):void
---@alias TextLoadCallback fun(controller: CS.UnityEngine.TextAsset):void
